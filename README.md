...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/sweet-sunset-2fb3
```

A live public deployment of this template is available at [https://sweet-sunset-2fb3.templates.workers.dev](https://sweet-sunset-2fb3.templates.workers.dev)
